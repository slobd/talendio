                            ...
                            <span
                                ...
                                style={{
                                    backgroundImage: pathname === link || isHoveredItem === id
                                        ...
                                        : "",
                                    textShadow: pathname === link || isHoveredItem === id ? "0 0 1px black, 0 0 1px black" : ""
                                }}
                ...
                <div className="absolute top-20 left-0 w-full bg-gradient-to-b from-[#E5F0FB] to-gray-500 text-black py-2">
                    <ul className="flex flex-col justify-center items-center ">
                        {navItems.map(({ id, label, link }) => (
                            <li
                                key={id}
                                className="text-center px-2 cursor-pointer capitalize py-3 text-[15px] font-normal hover:text-gray-500"
                            >
